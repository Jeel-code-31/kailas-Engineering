...
const processingSteps = [
  {
    ...
    category: "Step 01",
    icon: <Sun size={20} />,
    image: "/products/Hydration/First.png",
  ...
  },
  {
    ...
    image: "/products/Hydration/Second.png",
  ...
  },
  {
    ...
    category: "Step 03",
    icon: <Flame size={20} />,
    image: "/products/Hydration/Thiree.png",
  ...
  },
  {
    ...
    category: "Step 04",
    icon: <Flame size={20} />,
    image: "/products/Hydration/Four.png",
  ...
  },
  {
    ...
    category: "Step 05",
    icon: <Droplets size={20} />,
    image: "/products/Hydration/Five.png",
  ...
  },
  {
    ...
    image: "/products/Hydration/Six.png",
...
export default function FruitDehydrationSection() {
  return (
    <section className="py-24 bg-[#F9F6F0] relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          Fruit And Vegitable Dehydration
          </h2>
